...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.btnPlotGraph, 5, 1, 1, 1)
        self.btnCalculate = QtWidgets.QPushButton(self.centralwidget)
        self.btnCalculate.setObjectName("btnCalculate")
        self.gridLayout.addWidget(self.btnCalculate, 5, 2, 1, 1)
        MainWindow.setCentralWidget(self.centralwidget)
        self.menubar = QtWidgets.QMenuBar(MainWindow)
        self.menubar.setGeometry(QtCore.QRect(0, 0, 551, 31))
